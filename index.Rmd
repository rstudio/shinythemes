      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <div class="prev col-xs-1 col-sm-1 col-md-1">&lt;</div>
              <div class="modal-img col-xs-10 col-sm-10 col-md-10">
                <img src="images/', theme, '.png">
              </div>
              <div class="next col-xs-1 col-sm-1 col-md-1">&gt;</div>
            </div>
          </div>
        </div>
      </div><!-- /.modal-content -->
...
output <- paste0(c( 
  ...
  .prev, .next, .thumbnail, .modal-img .modal-body {
